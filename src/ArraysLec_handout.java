...
public class ArraysLec_handout {
    ...
    public static void main(String[] args) {
        ...
        //Key differences coming from JS:
        // a. arrays have a fixed length that we **must** set,
        // b. arrays have a set data type [with all elements matching].
        //** Structure **
        //double[] prices;
        ...
        System.out.println("groceryList[0] = " + groceryList[0]);//null [Strings aree what in java? OBJECTS]
        //TODO Together: What if we try to refer to an index beyond what we have set up?

        //System.out.println("sidesArray[120] = " + sidesArray[120]);//array is out of bounds( beyond the set about of elements in the array
        ...
        String[] cohort = {"Marco", "Oberon", "Neptune", "Polaris"};

        System.out.println("Hey, good to see you  today " + cohort[0] + "students! did you know out upcoming cohort is going to be named "+ cohort[3]);
        ...
        String[] Siblings = {"Aalyiah", "Ashea", "Tyewaune", "Aaron", "Andreco", "Adrian", "Ashley", "Jenea", "Kylen"};

        System.out.println("My oldest sibiling is " + Siblings[6] + " and my youngest is " + Siblings[7]);
        ...
        for(int i =0; i < cohort.length; i++){
            System.out.println("Codeup has a number of cohorts! One of them is the "  + cohort[i]  + "cohort " );
        }
        ...
        for(String  cohorts: cohort){
            System.out.println("Codeup runs a few cohorts at a time - one of the ones from 2021 is " + cohorts);
        }
//        //TODO: Using the array you set up above, practice iterating through the array using both of our types of for loops. When might you choose to use one over the other?
        for(String sibling : Siblings ){
            System.out.println( "I have many sibilings in my family one's name is "+ sibling);
        }
//
        //~*~ Java array.methods() ~*~
...
String [] newList = Arrays.copyOf(groceryList, 3);
        ...
        System.out.println();
        System.out.println("Arrays.toString(cohort) = " + Arrays.toString(cohort));
       ...
       System.out.println( Arrays.toString(cohort).replace("[", "").replace("]", ""));

       String cohortNameString = Arrays.toString(cohort).replace("[", "").replace("]", "");
        System.out.println("These are the cohorts " + cohortNameString);
        ...
        System.out.println("Deploying MIB personnel to counter alien activity!");
         System.out.println("MIB Officer Douglas H. headed to grid area " + matrix[2][1] + "!"); //should say "grid area 6!"
         System.out.println("MIB Officer Larry C. headed to grid area " + matrix[0][2] + "!"); //should say "grid area 7!"
         System.out.println("MIB Officer Kenneth H. headed to grid area " + matrix[1][0] + "!"); //should say "grid area 2!"
