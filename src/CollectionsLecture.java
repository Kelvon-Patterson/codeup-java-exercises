...
//
//        System.out.println(cohortMember);
//        System.out.println("cohortMember.get(0) = " + cohortMember.get(0));
//        System.out.println("cohortMember.get(1) = " + cohortMember.get(1));
//        System.out.println("cohortMember.get(2) = " + cohortMember.get(2));
...
//        System.out.println(names.get(5)); // ? -- Exception index 5 out of bounds for length 3
...
//        "Justin" could be returned from nameHashMap.get("Reich")
        ...
        names.put("Sergio", "Davila");
        names.put("Kelvon", "Patterson");
        names.put("Nathan", "Adcock");
        System.out.println(names);
